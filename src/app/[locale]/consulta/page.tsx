      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a 
            ...
            className="inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-[#0F1117] bg-[#C9974A] rounded-full hover:bg-[#D4A35B] hover:scale-[1.02] transition-all shadow-[0_0_20px_rgba(201,151,74,0.3)] w-full sm:w-auto"
          >
          ...
          <a 
            href="https://maps.app.goo.gl/wZsVaziG8xDLNNTn9" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-[#C9974A] bg-[#1A1D24] border border-[#C9974A]/30 rounded-full hover:bg-[#252A34] hover:scale-[1.02] transition-all shadow-[0_0_15px_rgba(201,151,74,0.1)] w-full sm:w-auto"
          >
